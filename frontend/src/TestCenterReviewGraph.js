...
class TestCenterReviewGraph extends React.Component {
    constructor(props) {
        super(props);
        ...
        const url = process.env.REACT_APP_API_URL + "/test_center_reviews/graph/" + this.user_id;
...
export default TestCenterReviewGraph;